...
class IotHubGatewayDeviceAPIs(object):
    ...
    :vartype device: iot_hub_gateway_device_apis.aio.operations.DeviceOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = IotHubGatewayDeviceAPIsConfiguration(**kwargs)
    ...
    async def __aenter__(self) -> "IotHubGatewayDeviceAPIs":
