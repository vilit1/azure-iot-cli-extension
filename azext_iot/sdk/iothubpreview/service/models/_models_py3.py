...
class AuthenticationMechanism(msrest.serialization.Model):
    ...
    :type symmetric_key: ~azure.iot.gateway.service.models.SymmetricKey
    :param x509_thumbprint: The primary and secondary x509 thumbprints used for x509 based
     authentication.
    :type x509_thumbprint: ~azure.iot.gateway.service.models.X509Thumbprint
    ...
    :type type: str or ~azure.iot.gateway.service.models.AuthenticationMechanismType
    """
...
class BulkRegistryOperationResult(msrest.serialization.Model):
    ...
    :type errors: list[~azure.iot.gateway.service.models.DeviceRegistryOperationError]
    :param warnings: The device registry operation warnings.
    :type warnings: list[~azure.iot.gateway.service.models.DeviceRegistryOperationWarning]
    """
...
class Configuration(msrest.serialization.Model):
    ...
    :type system_metrics: ~azure.iot.gateway.service.models.ConfigurationMetrics
    :param metrics: The custom metrics specified by the developer as queries against twin reported
     properties.
    :type metrics: ~azure.iot.gateway.service.models.ConfigurationMetrics
...
class Device(msrest.serialization.Model):
    ...
    :param connection_state: The state of the device. Possible values include: "Disconnected",
     "Connected".
    :type connection_state: str or ~azure.iot.gateway.service.models.DeviceConnectionState
    ...
    :type status: str or ~azure.iot.gateway.service.models.DeviceStatus
    ...
    :type authentication: ~azure.iot.gateway.service.models.AuthenticationMechanism
    :param capabilities: The set of capabilities of the device. For example, if this device is an
     edge device or not.
    :type capabilities: ~azure.iot.gateway.service.models.DeviceCapabilities
...
class DeviceRegistryOperationError(msrest.serialization.Model):
    ...
    :type error_code: str or ~azure.iot.gateway.service.models.DeviceRegistryOperationErrorCode
...
class ExportImportDevice(msrest.serialization.Model):
    ...
    :type import_mode: str or ~azure.iot.gateway.service.models.ExportImportDeviceImportMode
    :param status: The status of the module. If disabled, the module cannot connect to the service.
     Possible values include: "enabled", "disabled".
    :type status: str or ~azure.iot.gateway.service.models.ExportImportDeviceStatus
    :param status_reason: The 128 character-long string that stores the reason for the device
     identity status. All UTF-8 characters are allowed.
    :type status_reason: str
    ...
    :type properties: ~azure.iot.gateway.service.models.PropertyContainer
...
class JobProperties(msrest.serialization.Model):
    ...
    :type type: str or ~azure.iot.gateway.service.models.JobPropertiesType
    :param status: System generated. Ignored at creation. The status of the job. Possible values
     ...
     "queued".
    :type status: str or ~azure.iot.gateway.service.models.JobPropertiesStatus
    ...
    :type storage_authentication_type: str or
     ~azure.iot.gateway.service.models.JobPropertiesStorageAuthenticationType
    :param identity:
    :type identity: ~azure.iot.gateway.service.models.ManagedIdentity
...
class JobRequest(msrest.serialization.Model):
    ...
    :param type: The job type. Possible values include: "unknown", "export", "import", "backup",
     ...
     "factoryResetDevice", "firmwareUpdate", "scheduleDeviceMethod", "scheduleUpdateTwin",
     "restoreFromBackup", "failoverDataCopy".
    :type type: str or ~azure.iot.gateway.service.models.JobRequestType
    :param cloud_to_device_method: The method type and parameters. This is required if the job type
     is cloudToDeviceMethod.
    :type cloud_to_device_method: ~azure.iot.gateway.service.models.CloudToDeviceMethod
    :param update_twin: The state information for a device or module. This is implicitly created
     ...
     Hub.
    :type update_twin: ~azure.iot.gateway.service.models.Twin
...
class JobResponse(msrest.serialization.Model):
    ...
    :param type: The job type. Possible values include: "unknown", "export", "import", "backup",
     ...
     "factoryResetDevice", "firmwareUpdate", "scheduleDeviceMethod", "scheduleUpdateTwin",
     "restoreFromBackup", "failoverDataCopy".
    :type type: str or ~azure.iot.gateway.service.models.JobResponseType
    ...
    :param status: System generated.  Ignored at creation. The status of the job. Possible values
     include: "unknown", "enqueued", "running", "completed", "failed", "cancelled", "scheduled",
     "queued".
    :type status: str or ~azure.iot.gateway.service.models.JobResponseStatus
    ...
    :type device_job_statistics: ~azure.iot.gateway.service.models.DeviceJobStatistics
    """
...
class Module(msrest.serialization.Model):
    ...
    :type connection_state: str or ~azure.iot.gateway.service.models.ModuleConnectionState
    :param connection_state_updated_time: The date and time the connection state was last updated.
    :type connection_state_updated_time: ~datetime.datetime
...
class Properties(msrest.serialization.Model):
    ...
    :type topicspace_type: str or ~azure.iot.gateway.service.models.PropertiesTopicspaceType
    ...
    def __init__(
        self,
        *,
        topicspace_type: Optional[Union[str, "PropertiesTopicspaceType"]] = None,
...
class QueryResult(msrest.serialization.Model):
    ...
    :type type: str or ~azure.iot.gateway.service.models.QueryResultType
...
class Topicspace(msrest.serialization.Model):
    ...
    :type properties: ~azure.iot.gateway.service.models.Properties
    """
...
class Twin(msrest.serialization.Model):
    ...
    :type properties: ~azure.iot.gateway.service.models.TwinProperties
    ...
    :param status: The enabled status of the device. If disabled, the device cannot connect to the
     service. Possible values include: "enabled", "disabled".
    :type status: str or ~azure.iot.gateway.service.models.TwinStatus
    ...
    :param connection_state: The connection state of the device. Possible values include:
     "Disconnected", "Connected".
    :type connection_state: str or ~azure.iot.gateway.service.models.TwinConnectionState
    ...
    :param authentication_type: The authentication type used by the device. Possible values
     include: "sas", "selfSigned", "certificateAuthority", "none".
    :type authentication_type: str or ~azure.iot.gateway.service.models.TwinAuthenticationType
