...
class JobsOperations:
    ...
    async def create_import_export_job(
        self,
        job_properties: "_models.JobProperties",
        **kwargs: Any
    ) -> "_models.JobProperties":
    ...
    async def cancel_import_export_job(
        self,
        id: str,
        **kwargs: Any
    ) -> Optional[Any]:
    ...
    async def create_scheduled_job(
        self,
        id: str,
        job_request: "_models.JobRequest",
        **kwargs: Any
    ) -> "_models.JobResponse":
    ...
    async def query_scheduled_jobs(
        self,
