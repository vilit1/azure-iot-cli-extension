...
class IotHubGatewayServiceAPIs(SDKClient):
    ...
    :vartype statistics: service.operations.StatisticsOperations
    :ivar devices: Devices operations
    :vartype devices: service.operations.DevicesOperations
    :ivar bulk_registry: BulkRegistry operations
    :vartype bulk_registry: service.operations.BulkRegistryOperations
    :ivar query: Query operations
    :vartype query: service.operations.QueryOperations
    :ivar jobs: Jobs operations
    :vartype jobs: service.operations.JobsOperations
    :ivar cloud_to_device_messages: CloudToDeviceMessages operations
    :vartype cloud_to_device_messages: service.operations.CloudToDeviceMessagesOperations
    :ivar modules: Modules operations
    :vartype modules: service.operations.ModulesOperations
    :ivar digital_twin: DigitalTwin operations
    :vartype digital_twin: service.operations.DigitalTwinOperations
    :ivar topic_space: TopicSpace operations
    :vartype topic_space: service.operations.TopicSpaceOperations
