...
iothub_mintls_ops = CliCommandType(
    operations_tmpl="azext_iot.iothub.commands_tls_compatibility#{}",
)
...
def load_iothub_commands(self, _):
    ...
    with self.command_group("iot hub tls-compat", command_type=iothub_mintls_ops, is_preview=True) as cmd_group:
        cmd_group.command("show", "tls_compatibility_mode_show")
        cmd_group.command("set", "tls_compatibility_mode_set")
